...
| Nov.14th | Status report- teamwork |  Alumni Job Panel <br> Sprint review with mentors | [Writing 3 (Team)](lectures/writing.md) <b> Due Nov.19, Blackboard </b> <br> includes User Interface Design Document <br> 2. Group Feedback (opt)|
| Nov.21st | Status meeting: <br> prep for Alpha Prototype Demo | Thanksgiving Break |  |
| Nov.28th | Sprint Planning Meeting  | Presentations and PRDs <br> Standup meeting with mentors | Code Review 3 |
| Dec. 5 | Status updates on Demo1 <br> <b> [Demo 1: Alpha Prototype](lectures/presentations.md)  </b> | [Presentation 3:](lectures/presentations.md) <br>   | Writing 4 draft |
